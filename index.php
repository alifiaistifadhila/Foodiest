...
<body style="background-image:linear-gradient(rgba(238,214,212,255),rgba(238,214,212,255)); margin:8%;" class="bg-light">
  ...
  <center>
    <img src="assets/images/logo.png" width="400px" height="400px" style="margin-top: -50px"/>
  <p><button onclick="window.location.href='sign_up.php' "style="background-color: #cd0909; border: 2px solid #cc0c0c; border-radius: 30px; color: white; height: 60px; width: 250px; margin-top: -300px">Sign Up</button><br></p>
